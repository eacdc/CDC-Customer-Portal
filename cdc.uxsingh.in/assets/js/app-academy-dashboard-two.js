...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const leadsReportChartConfig = {
    ...
    series: [60, 40], // ✅ 60% filled, 40% remaining
    colors: [config.colors.primary, '#E3DFFC'], // ✅ Filled and background color
    stroke: {
      width: 0
    },
    dataLabels: {
        ...
        donut: {
          ...
          labels: {
            ...
            total: {
              ...
              //   show: false // we don't need 'total' in this design
            }
          }
        }
      }
  ...
  // DISABLED: Chart is now dynamically loaded from API in dashboards-analytics.js
